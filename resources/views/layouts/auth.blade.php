...
<head>
    <base href="{{ asset('/') }}">
    <title>@yield('title', 'Biblia Inmobiliaria | Auth')</title>

    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta name="description" content="Biblia Inmobiliaria - Administración" />
            ...
            <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
                <div class="d-flex flex-center flex-lg-start flex-column">
                    <a href="{{ url('/') }}" class="mb-7">
                        <img width="250px" alt="Biblia Inmobiliaria" src="{{ asset('assets/img/biblia-inmobiliaria-logo.svg') }}" />
                    </a>
